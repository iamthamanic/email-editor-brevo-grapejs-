...
test.describe("Phase 1 Foundation", () => {
  ...
  test("AUTH_MODE non-dev returns 401", async ({ request }) => {
    // Cannot flip process env mid-run — document as API contract unit/manual.
    // Smoke: with current AUTH_MODE=dev, health reports authMode.
