...
| variables | Variables | implemented |
| brevo-publish | Brevo Publish | implemented |
| brevo-sync | Brevo Sync (pull + conflict resolve) | implemented |
| legacy-importer | Legacy HTML Importer | implemented |
| textbausteine | Textbausteine + harvest | implemented |
...
| deploy | Production hosting | planned |
